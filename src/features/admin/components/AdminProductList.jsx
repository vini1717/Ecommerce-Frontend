              ...
              >
                ...
                <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                  ...
                  <div>
                      ...
                      className="rounded-md mx-8 my-5 bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                          + Add New Product
                      </Link>
                  </div>
                ...
                <div>
                  ...
                  >
                    ...
                    {Array.from({length: Math.ceil(totalItems/ITEMS_PER_PAGE)}).map((el,index)=>(
                      ...
                      aria-current="page"
                      className={`relative cursor-pointer z-10 inline-flex items-center ${page===index+1 ? 'bg-indigo-600 text-white': 'text-gray-400'}  px-4 py-2 text-sm font-semibold focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600`}
                    >
                      {index+1}
                    </div>
                    ))}
